...
For further pricing information, click [here](https://www.yoco.com/za/fees/).

= Quick installation and setup =
[Instructions video here](https://www.youtube.com/watch?v=r4jZijo67V4)
...
For more details, please click [here](https://support.yoco.help/s/article/Yoco-for-WooCommerce).
...
- WordPress version 5.0.0 to 6.3.1
- WooCommerce version 4.0.0 to 8.1.0
...
More detailed installation notes can be found [here](https://support.yoco.help/s/article/Yoco-for-WooCommerce) or you can get in touch with us [here](https://www.yoco.com/za/contact/).
