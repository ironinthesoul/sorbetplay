...
-   `pnpm start` (starts the local environment)
-   `pnpm test-e2e` (runs tests in headless mode)
-   `pnpm test-e2e-ui` (runs tests in UI mode)

To run the test again, re-create the environment to start with a fresh state:

-   `pnpm destroy` (destroy the local environment)
